...
[0] = LAYOUT(
    ...
    _______, KC_Z,    KC_X,    KC_C,    KC_V,   KC_B,                KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, _______, \
             KC_MINS, KC_GRV, KC_QUOT, KC_EQL,                      KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, \
            LT(1, KC_BSPC), LSFT_ESC, _______, _______, LCTL_SPC,            LCTL_ENT,_______, _______, LSFT_LBRC, RALT_RBRC \
),
[1] = LAYOUT(
...
/*     _______, G(KC_1), G(KC_2), G(KC_3), G(KC_4), G(KC_5),             _______, KC_4,    KC_5,    KC_6,    _______, _______, \ */
/*     _______, _______, _______, _______, _______, KC_PSCR,             _______, KC_1,    KC_2,    KC_3,    KC_BSLS, _______, \ */
/*               OSL(2), _______, _______, _______, _______,             KC_BSPC, _______, _______, KC_RBRC, _______           \ */
/* ), */
/* [2] = LAYOUT( */
/*     _______, _______, _______, _______, _______, _______,             _______, _______, _______, _______, _______, _______, \ */
/*     _______, _______, _______, _______, _______, _______,             _______, _______, _______, _______, _______, _______, \ */
